...
window.QA_CONFIG = {
  ...
  text: {
    ...
    // 미니 질문형(compose.html) — 가이드 페이지 하단
    mini: {
      collapsed: '막힌 부분을 질문으로 남기기',
      pastCount: '지난 질문 {n}건',
      ...
      submit: '등록',
      similarLabel: '비슷한 질문',
      similarAnswered: '답변 있음',
      similarWaiting: '아직 답변 없음',
      similarOpen: '보기',
      similarClose: '접기',
      ...
      failed: '등록하지 못했어요 · 작성 내용은 그대로 있습니다',
      failedHint: '눌러서 내용 고치기',
      retry: '재시도',
      noKey: '질문 기능이 연결되지 않았어요 · 위젯 주소를 다시 복사해 주세요',
      expired: '접근 키가 만료됐어요 · 키를 새로 발급해 주소를 갱신해 주세요',
      denied: '저장소에 쓸 권한이 없어요 · 관리자에게 권한 범위를 확인해 주세요',
