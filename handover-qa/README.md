...
- 목록형은 고른 작성자의 역할에 따라 다르게 보입니다. 답하는 사람에게는 **답을 기다리는 질문**을 맨 위에 모으고 카드에 마지막 글을 보여줍니다. 묻는 사람에게는 **아직 답이 오지 않은 자기 질문**을 맨 위에 모으고, 카드에 상대의 답 대신 자기가 쓴 질문을 보여줍니다. 새 답이 온 질문은 아래 목록에서 `NEW` 배지로 표시합니다.
